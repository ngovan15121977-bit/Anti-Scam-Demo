...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white w-full">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-50 via-pink-50 to-slate-50 w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-rose-100">
                ...
                <span className="text-sm font-medium text-slate-700">Được bảo vệ bởi AI Anti-Scam</span>
              </div>

              <h1 className="text-4xl lg:text-6xl font-extrabold text-slate-900 leading-tight">
                Ví điện tử <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-pink-600">thông minh</span>
                <br />
                cho cuộc sống hiện đại
              </h1>

              <p className="text-lg text-slate-600 leading-relaxed max-w-lg">
                Timi không chỉ là ví điện tử. Chúng tôi dùng trí tuệ nhân tạo để bảo vệ mọi giao dịch của bạn, giúp chuyển tiền, thanh toán và quản lý tài chính an toàn tuyệt đối.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() => navigate("/register")}
                  className="px-8 py-4 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-bold rounded-2xl shadow-xl shadow-rose-200 hover:shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-2"
                >
                  Trải nghiệm ngay
                ...
                <button
                  ...
                  className="px-8 py-4 bg-white text-slate-700 font-bold rounded-2xl border border-slate-200 hover:border-rose-300 hover:text-rose-600 transition-all"
                >
                  Vào trang chủ mỏng
                </button>
              </div>
              ...
              <div className="flex items-center gap-4 pt-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-white bg-gradient-to-br from-slate-200 to-slate-300 flex items-center justify-center text-xs font-bold text-slate-600"
                    >
                ...
                <p className="text-sm text-slate-500">
                  <span className="font-semibold text-slate-800">2 triệu+</span> người dùng tin tưởng
                </p>
              </div>
            </div>
            ...
            <div className="relative flex justify-end">
              <div className="absolute inset-0 bg-gradient-to-r from-rose-200 to-pink-200 rounded-[3rem] blur-3xl opacity-30" />
              <div className="relative bg-white rounded-[2.5rem] shadow-2xl shadow-rose-100/50 p-8 border border-rose-50 w-full max-w-md">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <p className="text-sm text-slate-400">Số dư ví</p>
                    <p className="text-3xl font-bold text-slate-800">50.000.000 đ</p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  <div className="p-4 bg-rose-50 rounded-2xl text-center">
                    <ArrowRight className="w-6 h-6 text-rose-500 mx-auto mb-2" />
                    <p className="text-xs font-semibold text-slate-700">Chuyển tiền</p>
                  </div>
                  ...
                  <div className="p-4 bg-emerald-50 rounded-2xl text-center">
                    ...
                    <p className="text-xs font-semibold text-slate-700">Nạp điện thoại</p>
                  </div>
                  <div className="p-4 bg-violet-50 rounded-2xl text-center">
                    <TrendingUp className="w-6 h-6 text-violet-500 mx-auto mb-2" />
                    <p className="text-xs font-semibold text-slate-700">Tiết kiệm</p>
                  </div>
                </div>

                <div className="p-4 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl text-white">
                  <div className="flex items-center gap-2 mb-2">
                    <Shield className="w-5 h-5" />
                    <span className="font-bold text-sm">AI Anti-Scam đang bảo vệ</span>
                  </div>
                  <p className="text-xs text-emerald-100">Đã quét và an toàn 100% giao dịch hôm nay</p>
                </div>
              </div>
            </div>
          </div>
